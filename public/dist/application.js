    ...
    function appRoutes($stateProvider, $locationProvider, $urlRouterProvider, helper){
      ...
      $stateProvider
        .state('app', {
          ...
          resolve: helper.resolveFor('modernizr', 'icons', 'angular-keyboard', 'oitozero.ngSweetAlert', 'ngDialog')
        })
        .state('app.home', {
          url: '/home',
...
]).controller('AngularCarouselController', ['$scope',
	function($scope) {
		var vm = this;
...
(function() {
    ...
    function settingsRun($rootScope, $localStorage){
      ...
      $rootScope.app = {
        name: 'ArquitetaWeb',
        description: 'Parada de Onibus TOP',
